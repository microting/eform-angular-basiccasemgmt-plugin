...
describe('Application settings page - site header section', function () {
  ...
  it('should go to plugin settings page', function () {
    ...
    if (plugin.name === 'Microting Case Management Plugin') {
    ...
    if (pluginTwo.name === 'Microting Case Management Plugin') {
      expect(pluginTwo.name).equal('Microting Case Management Plugin');
    } else {
